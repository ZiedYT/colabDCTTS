...
##use this to get the text to be used in synthesize.py
def getNormalText(text):
...
def load_data(mode="train"):
    ...
    if mode=="train":
        if "LJ" in hp.data:
            ...
            lines = codecs.open(transcript, 'r', 'latin-1').readlines()
            for line in lines:
                ...
                fpath = fpath.replace(".wav.wav",".wav")
                fpaths.append(fpath)
